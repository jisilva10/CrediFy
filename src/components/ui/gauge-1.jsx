...
export function Gauge({
    ...
    // Convert absolute value to a percentage based on min/max
    const strokePercent = ((animatedRawValue - min) / (max - min)) * 100;
    ...
    const getColor = (colorProp, isSecondary = false) => {
        ...
        if (typeof colorProp === "string") {
            return defaultColors[colorProp] || colorProp
        }
        ...
        return isSecondary ? "#e2e8f0" : "#2563eb"
    }
            ...
            >
                ...
                {label && (
                    <text
                        ...
                        fontSize={6.5}
                        fontWeight="bold"
                        className="fill-slate-900 uppercase tracking-widest"
